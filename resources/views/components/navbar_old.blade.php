<nav x-data="{ open: false }" class="sticky top-0 z-50 shadow-md flex flex-col md:flex-row" id="navbar-sticky">
    <div class="w-full mx-auto px-6">
        <div class="flex justify-between items-center h-16 mt-4 md:mt-0">
            ...
            <div class="hidden md:flex space-x-6">
                <a href="{{ route('homepage') }}" class="text-xl font-semibold text-white opacity-80 hover:opacity-100 transition">
                    Home
                </a>
    ...
    <div x-show="open"
        ...
        <a href="{{ route('homepage') }}" class="block text-xl font-semibold text-white opacity-80 hover:opacity-100 transition">
            Home
        </a>
